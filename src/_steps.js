...
9. create a google auth provider. do not forget to use  new before GoogleAuthProvider(); 
10. go to firebase > Build > Authentication > Sign In method > Select Google 
11. Enable google sign in method, and give a support email of yours
12. Create a button for google sign in method with a click handler
13. inside the event handler, call signInWithPopup with auth and provider as param
14. after singInWithPopup .then result , .catch error 
-------------------------------
    DISPLAY DATA
-------------------------------
